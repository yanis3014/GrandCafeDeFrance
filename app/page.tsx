...
export default function HomePage() {
  return (
    <div className="h-screen w-full flex flex-col lg:flex-row" suppressHydrationWarning>
      {RESTAURANTS.map((restaurant, index) => (
        <motion.div
          ...
          className="relative flex-1 group overflow-hidden transition-all duration-500 lg:hover:flex-[1.5] min-h-[50vh] lg:min-h-screen"
        >
          {/* Background Image */}
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-primary/60 to-primary/95 lg:group-hover:from-transparent lg:group-hover:via-primary/30 lg:group-hover:to-primary/90 transition-all duration-500" />
          </div>
          ...
          <div className="relative h-full flex flex-col items-center justify-center px-6 text-center">
            ...
            >
              ...
              {/* Restaurant Name - always visible on mobile */}
              ...
              <p className="font-lato text-white/90 text-sm md:text-base max-w-sm opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-500 leading-relaxed drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)]">
